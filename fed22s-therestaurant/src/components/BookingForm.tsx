...
return (
  <div className="form-wrapper ">
    ...
    {showDate && <form onSubmit={searchAvalibleTables}>
    ...
    {showTime && <form onSubmit={chooseTime}>
    <div className="form-group">
    <label>Välj tid
    ...
    {noTables && <div className="form-group"> Tyvärr fanns inga lediga bord denna dag <button>Gör ny sökning</button></div> }

     {showPersonForm && <form onSubmit={handleSubmitBooking}>
     <div className="form-group">
    <label htmlFor="name"> Namn:</label>
    <input type="text" value={userInput.guest.name} onChange={handleChangeTwo} name="name" required/>
    </div>
    <div className="form-group">
